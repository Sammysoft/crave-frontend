...
const BankDetailsMenu = ({ bankdetails, storename }) => {
  ...
  const addBankDetails = () => {
    ...
    axios
      .post(`${api}merchant/settings/bank`, payload)
      .then((res) => {
        setForm(false);
        Swal.fire({
          icon: "success",
            ...
            <ContentWrapper>
              <BankFormHead>
                ...
                <AccountButtonWrapper>
                  ...
                  >
                    Add Bank Account <img src={plus} alt="plus icon" />
                  </NewBankAccount>
                </AccountButtonWrapper>
              </BankFormHead>
            </ContentWrapper>
          ...
          <div style={StyledObject.storeMenu}>
            ...
            <ContentWrapper>
              <AccountButtonWrapper>
                ...
                >
                  New Bank Account <img src={plus} alt="plus icon" />
                </NewBankAccount>
              </AccountButtonWrapper>
