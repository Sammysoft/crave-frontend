...
const Downtime = ({ orders }) =>{
    return(
        <>
                <div style={StyledObject.missedOrdersWrapper}>
                           <span style={StyledObject.missedOrderHeader}> Downtime <span style={StyledObject.more}>0</span></span><br/><hr style={{color: '#FEB52E'}}/>
                    ...
                    {orders !=0 ?
                        <>
                           ...
                           <span style={{width: '100%', textAlign: 'right', float: 'right', padding: '5px'}}><span style={StyledObject.more}>More </span></span>
                        </>:<>
                        <div style={StyledObject.storeInfo}>
                                <StatusInfo>You have not had any downtime</StatusInfo>
                          </div>
                        </>
                    }
