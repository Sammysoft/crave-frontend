    ...
    return(
        <>
                <div style={StyledObject.missedOrdersWrapper}>
                           <span style={StyledObject.missedOrderHeader}> Missed Order<span style={StyledObject.more}>0</span></span><br/><hr style={{color: '#FEB52E'}}/>
                         {orders.length != 0 ?
                        <>
                           ...
                           <span style={{width: '100%', textAlign: 'right', float: 'right', padding: '5px'}}><MoreWrapper className="More" ><a href="/orders/missed">More</a> </MoreWrapper></span>
                        </>:<>
