...
const Auth = ()=>{
    ...
    const login = () =>{
        ...
        axios.post(`${api}merchant/auth`, payload)
            .then(user=> {
        ...
        <div style={{backgroundColor: 'transparent', width: '90%', margin: 'auto', height: "auto", padding: '100px 10px',     fontFamily: 'Nunito'}}>
            ...
            <div style={StyledObject.formWrapper}>
                    ...
                    <SimpleText><i>Fill in your business details</i></SimpleText>
                      <span style={{ width: "47%", display: "flex", alignItems: "center"}}><SimpleText2>Are you a new CRAVE member?</SimpleText2><LoginButton><Link style={{textDecoration: "none", textDecorationLine: "none", color: "#BD0000"}} to="/merchant/">Sign up</Link></LoginButton>
                    </span>
                    </div>
                ...
                <SignInWrapper>
                        <div style={StyledObject.storeMenuContentFields}>
                            ...
                            <span style={StyledObject.storeMenuFirstField}>Email Address:</span>
                            <div style={StyledObject.bottomInputWrapper}>
                            <input type="email" name="careline1" value={storemail} onChange={(e)=> setStoremail(e.target.value)} style={StyledObject.storeMenuInputField2} />
                            <div style={StyledObject.bottomInputWrapper}>
                            <span style={StyledObject.inputLabel}>Password:</span>
                            <input type="password" name="password" value={password} onChange={(e)=> setPassword(e.target.value)} style={StyledObject.storeMenuInputField2} />
                            </div>
                        </div>
                    </div>
